...
<div markdown="1">
근태관리와 연차관리를 맡아 프로젝트에 참여하였습니다. 처음 역할을 맡았을 때 근태관리는 간단한 로직이라고 생각하였습니다. 하지만 코드를 작성하고 테스트케이스를 작성하는 과정에서 간단한 로직 속에서도 다양한 예외상황이 존재하고 개발자가 책임져야하는 에러범위는 상당히 넓다는 것을 배웠습니다. 다소 아쉬운 점은 MSA 방식에 익숙하지는데에 시간을 많이 소비하여 스케줄러를 통한 연차자동부여를 구현하지 못하였다는 점입니다. 처음 목표였던 연차에 대한 자동화를 완성하지 못한 것이 아쉽게 느껴집니다. 그래도 MSA 방식에 많은 시간을 소비하며 하나의 서비스만을 완성시키는 것을 넘어 다른 서비스와의 통신 방식, 장애 상황까지 함께 고민하는 방법을 배울 수 있었던 것 같습니다.
</div>
</details>
